(() => {
  ...
  var require_lib = __commonJS((exports) => {
    ...
    class View3 {
      ...
      static isAdded(view) {
        ...
        return View3.isAdded(view.superview);
      }
    }
    class RootView extends View3 {
  ...
  var require_LayoutView = __commonJS((exports) => {
    __export(exports, {
      default: () => LayoutView
    });
    const jff_canvas3 = __toModule(require_lib());
    class LayoutView extends jff_canvas3.View {
      constructor(frame) {
        super(frame);
  ...
  class RectangleView extends jff_canvas.View {
    constructor(frame) {
      super(frame);
      this.handles = [];
  ...
  const HANDLE_SIZE = 8;
  class ResizeView extends jff_canvas2.View {
    constructor(frame) {
      super(frame);
      ...
      const addHandle = (index) => {
        const handle = new jff_canvas2.View({x: 0, y: 0, width: HANDLE_SIZE, height: HANDLE_SIZE});
